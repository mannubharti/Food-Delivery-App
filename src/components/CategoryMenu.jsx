...
const CategoryMenu = () => {
  ...
  const ListUniqueCategories = () => {
    ...
    console.log('uniqueCategories=', uniqueCategories); ['Lunch', 'Breakfast', 'Dinner', 'Snacks']
  };
...
const selectedCategory = useSelector((state) => state.category.category);
  ...
  return(
    <div className="ml-6">
      ...
      <div className='my-5 flex gap-3 overflow-x-scroll scroll-smooth lg:overflow-x-scroll'>
      <button
